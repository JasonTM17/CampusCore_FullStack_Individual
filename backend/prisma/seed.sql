...
SELECT gen_random_uuid(), 'Spring 2025', 'SPRING', ay.id, '2025-01-15', '2025-05-15', '2024-12-01', '2025-01-14', '2025-01-15', '2025-02-01', 'IN_PROGRESS', NOW(), NOW()
...
SELECT gen_random_uuid(), 'Fall 2025', 'FALL', ay.id, '2025-09-01', '2025-12-31', '2025-07-01', '2025-08-31', 'CLOSED', NOW(), NOW()
FROM "AcademicYear" ay WHERE ay.year = 2025
ON CONFLICT DO NOTHING;
...
VALUES 
  (gen_random_uuid(), 'Faculty of Computer Science', 'FCS', 'Faculty of Computer Science and Information Technology', true, NOW(), NOW()),
  (gen_random_uuid(), 'Faculty of Engineering', 'FE', 'Faculty of Engineering', true, NOW(), NOW()),
  (gen_random_uuid(), 'Faculty of Business Administration', 'FBA', 'Faculty of Business Administration', true, NOW(), NOW())
ON CONFLICT DO NOTHING;
